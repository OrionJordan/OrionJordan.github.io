---
title: "SEPARATION AXIOMS BETWEEN To AND T1 "
format:
  html:
    toc: true
...
Then $A$ is said to be [weakly separated]{.definition} from $B$ if there exist an open set $G$ such that $A \subset G$ and $G \cap B = \varnothing$.
:::
