...
Suppes 'Axiomatic Set Theory' spends a few pages relating equinumoristy to other operations and relations to simplify the development of cardinal arithmetic. 

::: {.callout-note icon="false"}
## Theorem (Equinumerosity of union of disjoint sets)
...
The following theorems will set up for cardinal exponentiation.
