...
We now know what symbols are used in our language, how we can combine them into formulas, and the differences between bound and free variables. We now move onto the semantics of first-order logic.
